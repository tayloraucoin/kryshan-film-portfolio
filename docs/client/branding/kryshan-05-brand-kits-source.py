...
KIT_A=dict(letter="A", name="Wicked leads · red on black", ground=BLACK_A, text=BONE, accent=RED_A, line="#2A2A2D",
 ...
 card=dict(essence="A tale well told, and a good time telling it.",
   # Card A v2 (04 Step 8, 2026-09-24): his order; Generous retired for Galvanizing;
   # Resourceful re-guarded "never cheap". The rendered PDF predates this and is the round's record.
   pillars=[("Wicked","Wicked but not nasty.","wonderfully wrong, deadpan, subversive, cinematic-dark"),
            ("Resourceful","Resourceful but never cheap.","any genre, slick under constraint, one-person unit, precise"),
            ("Galvanizing","Galvanizing but not domineering.","gets a room moving, can come with the crew, actors win, credits everyone")],
   tiebreak="When the wicked choice and the safe choice conflict, wicked wins, and the chrome pays for it with precision. When a line could be read as a discount or a plea, rewrite it."),
 ...
 roles=[("Ground",BLACK_A,"Every page. Never pure #000; the frames need somewhere to sit."),
        ...
        ("Passion / client",nA[300]+" / "+RED_A,"The two lanes: paid work named by its client in secondary text (never 'For hire'), passion tagged in red. The only place colour divides content.")],
