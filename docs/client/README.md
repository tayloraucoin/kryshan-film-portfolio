...
| `kryshan-04-brand-pillars.md` | 4 | The three pillar cards behind kits A, B, C. |
...
- Do not edit Vitrine's files. If a build diverges from them, the divergence is logged in `docs/specs/DEVIATIONS.md`, not patched into the deliverable.
